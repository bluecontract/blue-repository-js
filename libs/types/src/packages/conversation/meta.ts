...
const meta = {
  ...
  typesMeta: {
    ...
    G6GMCB3AQvH2xR12RiDvaCiEbCjgz4uhjKssDMRXbCTG: {
      status: 'dev',
    ...
    CN5efWVizJbRsMCw8YWRfT2q9vM9XfeGDN9wFvYcvMnQ: {
      status: 'stable',
      name: 'Actor',
      versions: [
        {
    ...
    '9KDfK6k1HBAyHckj5VuWXFMLkgY5cJBESKT4eoq1bnrw': {
      status: 'dev',
      name: 'Change Request',
      versions: [
        {
    ...
    DEmFwGa1sWm2BKhrN98LREKiB8j8B8kFAo7KBkkaojnN: {
      status: 'dev',
    ...
    '5Wz4G9qcnBJnntYRkz4dgLK5bSuoMpYJZj4j5M59z4we': {
      status: 'stable',
      name: 'Event',
      versions: [
        {
    ...
    BoAiqVUZv9Fum3wFqaX2JnQMBHJLxJSo2V9U2UBmCfsC: {
      status: 'stable',
      name: 'Operation',
      versions: [
        {
    ...
    GfqZJJtSJfd69v3pJ67XURdzhC4byWJZAstCh6i4X6MZ: {
      status: 'dev',
    ...
    '8f9UhHMbRe62sFgzQVheToaJPYi7t7HPNVvpQTbqfL5n': {
      status: 'stable',
      name: 'Request',
      versions: [
        {
    ...
    '36epvrpVHZLjapbeZsNodz2NDnm7XZeNZcnkWHgkP1pp': {
      status: 'stable',
      name: 'Response',
      versions: [
        {
    ...
    '7X3LkN54Yp88JgZbppPhP6hM3Jqiqv8Z2i4kS7phXtQe': {
      status: 'stable',
    ...
    '3Ge54FsGJaaeZmm8nTKJdS6HVdYhiR3g18fDwg3Ev1Sa': {
      status: 'stable',
      name: 'Timeline',
      versions: [
        {
