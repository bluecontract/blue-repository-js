export const CompositeTimelineChannel = {
  ...
  "channels": {
    ...
    "description": "List of contracts-map keys (Text) of channels in the same scope to compose (union). Each entry must name an existing Channel contract.\n"
  }
} as const;
