...
import { InformUserAboutPendingActionSchema } from './InformUserAboutPendingAction';
import { JavaScriptCodeSchema } from './JavaScriptCode';
...
import { RejectChangeOperationSchema } from './RejectChangeOperation';
import { RejectChangeWorkflowSchema } from './RejectChangeWorkflow';
...
import { StatusInProgressSchema } from './StatusInProgress';
import { StatusPendingSchema } from './StatusPending';
import { TimelineSchema } from './Timeline';
import { TimelineChannelSchema } from './TimelineChannel';
import { TimelineEntrySchema } from './TimelineEntry';
import { TriggerEventSchema } from './TriggerEvent';
import { UpdateDocumentSchema } from './UpdateDocument';
...
export { InformUserAboutPendingActionSchema } from './InformUserAboutPendingAction';
export { JavaScriptCodeSchema } from './JavaScriptCode';
...
export { RejectChangeOperationSchema } from './RejectChangeOperation';
export { RejectChangeWorkflowSchema } from './RejectChangeWorkflow';
...
export { StatusInProgressSchema } from './StatusInProgress';
export { StatusPendingSchema } from './StatusPending';
export { TimelineSchema } from './Timeline';
export { TimelineChannelSchema } from './TimelineChannel';
export { TimelineEntrySchema } from './TimelineEntry';
export { TriggerEventSchema } from './TriggerEvent';
export { UpdateDocumentSchema } from './UpdateDocument';

export const schemas = {
  APk3siB8g9pvWLG3qyqtGjRNNGB7RDpFWQtG4epj5Avv: AcceptChangeOperationSchema,
  BAYbnfs8WkdH33UwCvmsuoAq6MyU6ha4KSTZPaeMp9kN: AcceptChangeWorkflowSchema,
  ...
  '5cwVBvBpQWLmYmpAMfXVt7mGrrZDZinBkdgJ61oT2FGR': ChangeWorkflowSchema,
  ...
  CZBP6a8kS4bKpA2f29oAfBpKVmw6PDLYXDyg8Ttx2ceE: CustomerConsentSchema,
  ...
  DEmFwGa1sWm2BKhrN98LREKiB8j8B8kFAo7KBkkaojnN: DocumentSectionChangesSchema,
  ...
  '8Akr9sdTkxBqMYWSGh8gHgoXQQeYEPfhV4s8fXeKTd9W':
    InformUserAboutPendingActionSchema,
  ExZxT61PSpWHpEAtP2WKMXXqxEYN7Z13j7Zv36Dp99kS: JavaScriptCodeSchema,
  ...
  ELAgjQ99vBZLGfY6tJMuPRnm3avxpByyZsXc65aKQmi4: ProposeChangeWorkflowSchema,
  ...
  FbCbhWAeTsbLsBNn4Fvy3hyqPXFo5166rVwQVYCrtDE5: RejectChangeWorkflowSchema,
  ...
  '6CtkPkPVtmiQJJienGdzvZf2qGTRQntLXfh8PYeMfxBX': StatusCompletedSchema,
  '5w8XTussoHoaLUy6gwou9Rz5Zxuh9yums9YDNjGdLCKV': StatusFailedSchema,
  FDEV1Q9rBZwaponjfRmZ4HsUHRwPC4gvmeHiRqvkLAkY: StatusInProgressSchema,
  HTTYTqakRbb53umfjRvryunCRm5QQm3mMArTrgUF5DxL: StatusPendingSchema,
